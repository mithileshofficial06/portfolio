...
function ProjectContent({ project }: { project: Project }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="rounded-lg p-4 mb-5 text-xs leading-[1.9]"
        style={{
    ...
    <>
      <section ref={sectionRef} id="projects" className="py-24 relative">
        ...
        <div className="max-w-[1100px] mx-auto px-6">
          ...
          <div
            ref={explorerRef}
            className="overflow-hidden md:h-[520px] h-auto"
            style={{
          ...
          >
            ...
            {/* ── Two-panel body (desktop) / stacked (mobile) ── */}
            <div className="flex flex-col md:flex-row md:h-[calc(100%-40px)]" style={{ minHeight: "300px" }}>
              {/* LEFT SIDEBAR — horizontal scroll on mobile, vertical on desktop */}
              <div
                className="flex-shrink-0 overflow-x-auto md:overflow-x-hidden md:overflow-y-auto md:w-[280px] w-full border-b md:border-b-0 md:border-r border-[#2a2a2a]"
                style={{
                  backgroundColor: "#0f0f0f",
                }}
              >
                {/* Explorer header — hidden on mobile to save space */}
                <div
                ...
                {projects.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      className="md:w-full flex items-center gap-2 md:gap-3 text-left transition-colors duration-150 relative whitespace-nowrap flex-shrink-0"
                      style={{
                        padding: "10px 16px",
