...
export default function Hackathons() {
  ...
  const getCardStyle = (index: number): React.CSSProperties => {
    ...
    if (adj === -1)
      return { transform: "translateY(-60%) scale(0.85)", opacity: 0.5, zIndex: 20, pointerEvents: "auto", filter: "brightness(0.5)", cursor: "pointer" };
    if (adj === 1)
      return { transform: "translateY(60%) scale(0.85)", opacity: 0.5, zIndex: 20, pointerEvents: "auto", filter: "brightness(0.5)", cursor: "pointer" };
    if (adj === -2)
  ...
  return (
    <section
      ...
      style={{ background: "#0a0a0a", padding: "60px 0 60px" }}
    >
      {/* Divider */}
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12">
        ...
        >
          ...
          <div
            ...
            style={{ height: "clamp(380px, 60vh, 600px)", maxWidth: "600px" }}
            onClick={goNext}
          >
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative p-5 md:p-8">
                      ...
                      {/* Hackathon name */}
                      <h3 className="font-heading font-bold text-xl md:text-[28px] mb-2 pr-20 md:pr-24" style={{ color: "#FFFFFF", letterSpacing: "-0.02em" }}>
                        {hack.name}
                      </h3>
