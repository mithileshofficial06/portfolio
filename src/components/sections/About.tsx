...
export default function About() {
  ...
  return (
    <section ref={sectionRef} id="about" className="relative overflow-hidden" style={{ padding: "60px 0" }}>
      ...
      <div className="max-w-[1100px] mx-auto px-6 relative" style={{ zIndex: 1 }}>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-10">
          ...
          <div
            ...
            style={{ ...paperStyle, padding: "clamp(28px, 5vw, 52px) clamp(20px, 4vw, 44px)", minHeight: "auto", opacity: 0 }}
          >
            <Pin />
            ...
            <div className="relative" style={{ fontFamily: "var(--font-caveat), cursive", fontSize: "clamp(18px, 3vw, 22px)", lineHeight: 2.0, color: "#1a1a1a" }}>
              <p className="mb-5">
