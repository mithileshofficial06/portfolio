...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={photoRef}
        className="absolute bottom-[22%] lg:bottom-0 right-[-10%] lg:right-auto lg:left-1/2 z-20 pointer-events-none translate-x-0 lg:-translate-x-[45%]"
        style={{ opacity: 0 }}
      >
        {/* Concentric circles */}
        ...
        <Image
          ...
          width={880}
          height={1100}
          className="w-auto block h-[60vh] lg:h-[90vh]"
      ...
      <div className="relative z-30 h-full max-w-[1440px] mx-auto px-5 sm:px-8 md:px-12 lg:px-16">
        <div className="flex flex-col lg:grid lg:grid-cols-2 h-full justify-between lg:items-stretch gap-0 py-6 lg:py-0">

          {/* ═══ LEFT COLUMN ═══ */}
          <div className="flex flex-col justify-start lg:justify-between py-0 lg:py-14 h-auto lg:h-full">
            {/* Top: greeting + name */}
            <div>
              <p
                ref={greetingRef}
              ...
              <h1
                ...
                style={{ fontSize: "clamp(2.5rem, 8vw, 7rem)", letterSpacing: "-0.04em", fontFamily: "'Clash Display', var(--font-space-grotesk), sans-serif", textTransform: "none", clipPath: "inset(0 100% 0 0)" }}
              >
              ...
              <h1
                ref={nameLine2Ref}
                className="font-heading font-black italic leading-[0.88] whitespace-nowrap"
                style={{ fontSize: "clamp(2.5rem, 8vw, 7rem)", letterSpacing: "-0.04em", color: "#CCFF00", fontFamily: "'Clash Display', var(--font-space-grotesk), sans-serif", textTransform: "none", clipPath: "inset(0 100% 0 0)" }}
              >
                KS
              </h1>
            </div>
          ...
          <div
            ref={statusRef}
            className="absolute bottom-[25px] right-5 left-auto top-auto lg:bottom-[15px] lg:left-[2rem] lg:top-auto lg:right-auto flex flex-col lg:flex-row items-end lg:items-center gap-2 lg:gap-4 z-50"
            style={{ opacity: 0 }}
          >
            ...
            <div className="inline-flex items-center gap-2 py-1.5 lg:py-2 px-3 lg:px-4 rounded-full bg-white/[0.04] border border-white/[0.12]">
              <div className="relative flex h-2 w-2 flex-shrink-0">
                ...
                <span className="relative inline-flex rounded-full h-2 w-2" style={{ backgroundColor: "#CCFF00" }} />
              </div>
              <p className="text-[11px] lg:text-[13px] text-white/50">
                Available for <span className="font-bold" style={{ color: "#CCFF00" }}>Projects</span>
              </p>
            </div>
            <a
              href="/api/resume"
              className="group inline-flex items-center gap-1.5 py-1.5 lg:py-2.5 px-3.5 lg:px-5 rounded-full transition-all duration-300 cursor-pointer"
            ...
            >
              <Download size={12} className="lg:size-[14px]" style={{ color: "#0a0a0a" }} />
              <span className="text-[10px] lg:text-[11px] font-mono uppercase tracking-[0.1em] font-bold">Resume</span>
            </a>
            <a
              href="https://github.com/mithileshofficial06"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-1.5 py-1.5 lg:py-2.5 px-3.5 lg:px-5 rounded-full transition-all duration-300 border border-white/15 hover:border-[#CCFF00]/50"
            ...
            >
              <Github size={12} className="text-white/60 group-hover:text-[#CCFF00] transition-colors duration-300 lg:size-[14px]" />
              <span className="text-[10px] lg:text-[11px] font-mono uppercase tracking-[0.1em] text-white/60 group-hover:text-[#CCFF00] transition-colors duration-300">GitHub</span>
            </a>
          </div>

          {/* ═══ RIGHT COLUMN ═══ */}
          <div className="flex flex-col justify-start lg:justify-between pt-4 pb-8 lg:pt-24 lg:pb-14 pl-0 lg:pl-[28%] h-auto lg:h-full mt-6 lg:mt-0">
            {/* Top: role titles */}
            <div>
              {/* 01 DEVELOPER */}
              <div ref={role1Ref} className="flex items-start gap-3 mb-3" style={{ opacity: 0 }}>
                ...
                <h2 className="font-heading font-black leading-[0.88] whitespace-nowrap" style={{ fontSize: "clamp(1.5rem, 6vw, 6.5rem)", letterSpacing: "-0.04em", fontFamily: "'Clash Display', var(--font-space-grotesk), sans-serif", textTransform: "none" }}>
              ...
              <div ref={role2Ref} className="flex items-start gap-3 mb-8" style={{ opacity: 0 }}>
                ...
                <h2 className="font-heading font-black leading-[0.88] whitespace-nowrap" style={{ fontSize: "clamp(1.2rem, 5vw, 5.5rem)", letterSpacing: "-0.04em", fontFamily: "'Clash Display', var(--font-space-grotesk), sans-serif", textTransform: "none" }}>
            ...
            {/* Bottom: CTA */}
            <div ref={ctaRef} className="mt-6 lg:mt-20 ml-0 lg:ml-12 mb-2 lg:mb-12" style={{ opacity: 0 }}>
